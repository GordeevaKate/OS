...
public class Main {
	...
	private void initialize() {
		...
		buttonChoose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dataManager.ChoiceFile(Integer.parseInt(textFieldId.getText()));
				panel.repaint();
			}
		});
		buttonChoose.setBounds(10, 280, 126, 23);
		frame.getContentPane().add(buttonChoose);

		JLabel lblSize = new JLabel("Size");
		lblSize.setBounds(148, 211, 26, 14);
		frame.getContentPane().add(lblSize);

		textFieldSize = new JTextField();
		textFieldSize.setColumns(10);
		textFieldSize.setBounds(187, 208, 32, 20);
